...
var ZeptoAutocomplete = {
    init: function(limit, _data, caseSensitive, showFunc, hideFunc, _id, template) {
        ...
        this.showFunction = typeof showFunc == 'function' ? showFunc: function() {
            resultContainer.show();
        };
        this.hideFunction = typeof hideFunc == 'function' ? hideFunc: function() {
    ...
    _successHandler: function(data) {
        ...
        $('.autocomplete-result li').on('click',
        function(evt) {
